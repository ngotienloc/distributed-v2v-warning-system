...
void task_localization(void *arg){
    ...
    while(1){
        ...
        /* ── 2. GPS staleness check — reset gps_valid after timeout ── */
        if (ego.gps_valid) {
        ...
        /* ── 3. Dead reckoning update ego (always runs) ── */
        dr_update(&dr,
            fused.accel_x_lin,
            fused.accel_y_lin,
